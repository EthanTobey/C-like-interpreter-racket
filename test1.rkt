...
(define result_list (list 10 14 45 55 1 115 'true 20 24 2 35 mpa_error 90 69 87 64 oos_error 125 100 2000400))
...
(define testproject
  (lambda ()
    ...
    (set! testfile (string-append "tests1/test" testnumstring ".txt"))
